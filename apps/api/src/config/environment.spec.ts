...
const valid = { DATABASE_URL: "postgresql://user:pass@localhost:5432/citari", JWT_ISSUER: "https://issuer.test", JWT_AUDIENCE: "citari", JWT_SECRET: "x".repeat(32), MFA_ENCRYPTION_KEY: "m".repeat(32) };
